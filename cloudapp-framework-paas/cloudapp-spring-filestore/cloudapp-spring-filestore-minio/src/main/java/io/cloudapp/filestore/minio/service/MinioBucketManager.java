 ...
 *
 */
package io.cloudapp.filestore.minio.service;
...
import io.cloudapp.filestore.minio.util.MinioExceptionConverter;
import io.cloudapp.filestore.minio.util.MinioUtil;
import io.minio.*;
...
public class MinioBucketManager implements BucketManager<MinioClient, io.minio.messages.Bucket,
    ...
    @Override
    public io.cloudapp.api.filestore.model.ObjectMetadata<StatObjectResponse> headObject(
            String bucketName,
        ...
        try {
            ...
            io.cloudapp.api.filestore.model.ObjectMetadata<StatObjectResponse> objectMetadata
                    = new io.cloudapp.api.filestore.model.ObjectMetadata<>();
