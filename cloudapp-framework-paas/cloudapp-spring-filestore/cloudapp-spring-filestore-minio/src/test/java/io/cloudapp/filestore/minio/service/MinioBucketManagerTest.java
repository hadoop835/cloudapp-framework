...
public class MinioBucketManagerTest {
    ...
    public void testListAllBucketsWithPrefix() throws Exception {
        ...
        // Run the test
        final List<io.cloudapp.api.filestore.model.Bucket<Bucket>> result = minioBucketManagerUnderTest.listAllBucketsWithPrefix(
    ...
    public void testCreateBucket2() throws Exception {
        // Setup
        final io.cloudapp.api.filestore.model.Bucket<Bucket> bucket = new io.cloudapp.api.filestore.model.Bucket<>();
        ...
        // Run the test
        final io.cloudapp.api.filestore.model.Bucket<Bucket> result = minioBucketManagerUnderTest.createBucket(
                bucket);
