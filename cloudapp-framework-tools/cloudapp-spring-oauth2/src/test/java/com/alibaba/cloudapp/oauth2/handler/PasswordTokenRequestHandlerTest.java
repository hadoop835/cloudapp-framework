...
public class PasswordTokenRequestHandlerTest {
    
    private PasswordTokenRequestHandler passwordTokenRequestHandlerUnderTest;
    
    @Before
    public void setUp() throws Exception {
        passwordTokenRequestHandlerUnderTest = new PasswordTokenRequestHandler(
    ...
    public void testCreate() throws Exception {
        ...
        // Run the test
        final RequestEntity<String> result = passwordTokenRequestHandlerUnderTest.create();
