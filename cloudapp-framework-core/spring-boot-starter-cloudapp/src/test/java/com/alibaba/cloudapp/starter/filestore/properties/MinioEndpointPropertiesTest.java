...
class MinioEndpointPropertiesTest {
    
    private MinioEndpointProperties endpointProperties;
    @Mock
    private ApplicationContext applicationContext;
    
    @BeforeEach
    void setUp() {
        endpointProperties = new MinioEndpointProperties();
    ...
    void testAccessKeyGetterAndSetter() {
        ...
        assertEquals(accessKey,
                     endpointProperties.getAccessKey()
        );
    }
    ...
    void testSecretKeyGetterAndSetter() {
        ...
        assertEquals(secretKey,
                     endpointProperties.getSecretKey()
        );
    }
    ...
    void testSetApplicationContext() {
        ...
        endpointProperties.setApplicationContext(
                applicationContext);
    }
