 ...
 */
public class CloudAppInvalidAccessException extends CloudAppException {
    
    private static final String CODE = "CloudApp.InvalidAccess";
    
    
    public CloudAppInvalidAccessException(String msg) {
        super(msg, CODE);
    }
