...
INSERT INTO tb_account (id, amount, user_id, username) VALUES (1, 116.00, '1', 'zhangsan');
INSERT INTO tb_account (id, amount, user_id, username) VALUES (2, 54.00, '2', 'lisi');
...
(
    ...
    user_id      varchar(255)   null,
    constraint UK8gkp8m00rias36suok36h9sw5
        unique (tx_id)
);
...
(
    ...
    log_status    int          null,
    rollback_info longtext     null,
    xid           varchar(255) null,
    branchId      bigint       null,
    logCreated    datetime     null,
    logModified   datetime     null,
    logStatus     int          null,
    rollbackInfo  longtext     null
);