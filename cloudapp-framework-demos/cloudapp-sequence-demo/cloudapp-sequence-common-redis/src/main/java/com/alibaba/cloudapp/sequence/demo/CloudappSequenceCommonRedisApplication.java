...
public class CloudappSequenceCommonRedisApplication implements InitializingBean {
    ...
    public void afterPropertiesSet() {
        ...
        System.out.println("Generated first queue sequence id: " + sequenceGenerator.nextId());

        long start = System.currentTimeMillis();
        for (int i = 0 ; i < 1000; i++) {
            System.out.println("Loop generating first queue sequence id: " + sequenceGenerator.nextId());
        }
