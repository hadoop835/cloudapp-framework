...
2.  定义 xxl-job worker 自动配置类 _**XxlJobWorkerConfiguration**_ ，使用注解 _**@ConditionalOnProperty(prefix = "com.alibaba.cloudapp.scheduler.xxl-job-worker",value = "enabled",havingValue = "true")**_ ；
